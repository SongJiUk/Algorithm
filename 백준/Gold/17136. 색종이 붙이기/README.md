# 와 진짜 오래걸렸네..
완전 탐색인거 알고 있었는데도 생각보다 오래걸렸다.. </br>
맨 처음 생각했던게 54321순으로 돌려가면서 해당 재귀에 MAP을 똑같이 0 으로 만들어버리자였는데. 생각이 꼬여서 이렇게 시도 안했다가.</br>
큐로도 받고, 별짓 다했다.. 근데 맨 처음 생각했던게 정답이었다... </br>
여기서 중요한건 5x5부터 덮어야된다는거..! 그래서 백트래킹이 있는건가?? </br>
암튼 골드2는 진짜 어렵네.. 플레는 어떻게 풀어야되는거야 대체.. </br>
