# 이분탐색으로 푸려다가 투포인터로 풀었다.
이분 탐색으론 어떻게 풀어야할지 고민 해봐야겠다. 투포인터랑 비슷하긴한데 </br>
이것도 한번에 맞출 수 있었는데 처음엔 디버그 코드 안지워서 틀리고, 두세번째에는 MAX값을 딱 10억에 맞춰놔서 틀렸다. 젠장 </br>
