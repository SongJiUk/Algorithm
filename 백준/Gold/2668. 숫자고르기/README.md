# 문제를 똑바로 자세히 읽자.
첫째 줄에서 숫자를 적절히 뽑으면, 그 뽑힌 정수들이 이루는 집합과, 뽑힌 정수들의 바로 밑의 둘째 줄에 들어있는 정수들이 이루는 집합이 일치한다 -> 이 부분을 정확히 읽지 않았다..</br>
처음에 이상하게 풀었네.. 집합이라고 적혀있는걸 못봐서... </br>
아무튼 내가 처음에 푼거에비해 난이도가 높길래 뭐지 하고있었는데 반례 하나를 보고 깨달았다. </br>
2 3 1 5 6 4 -> 이게 제일 중요한 반례였던것 같다. </br>
