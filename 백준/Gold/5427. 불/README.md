# BFS!
1. 배열 초기화 또 실수. 이제 그냥 동적할당을 해야겠다. </br>
2. 메모리 초과. BFS에서 메모리 초과가 뜨는경우는 거의 방문처리를 안해줘서 그런것같다. </br>
3. 틀림(나는 상근이가 뛰고나서 불이 따라오는줄...) 불이 먼저 퍼지고 상근이가 뛰는거였다. </br>

너무 잔실수가 많다.. </br>
몸에 기운이 없어서 그런건가.. ㅋㅋㅋ 담엔 깊게 생각하고 문제를 풀자
