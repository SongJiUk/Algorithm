# MOD와 나누기를 적절하게 사용하자. 
괜히 왼쪽으로 한칸씩 이동하는거랑, 오른쪽으로 한칸씩 이동하는 걸 deque로 해줘서 시간초과가 떴다.</br>
생각해보면 %와 / 를 적절하게 사용해주면 왼쪽으로 한칸 옮기는것도,오른쪽으로 한칸 옮기는것도 생각보다 쉽게 할 수 있다. </br>
또 하나 배워간다. </br>
