...
파스킬 삼각형은 이렇게 표현할 수 있음. </br>
![image](https://github.com/SongJiUk/Algorithm/assets/67099323/3d9a0b4a-8f31-40ac-a33a-cacf1afb71cc)
이렇게 풀면 DP를 이용해서 생각보다 쉽게 풀 수 있다. </br>
mod를 해줘야하는경우에는 값이 비정상적으로 커지기때문에 하라고 하는건데. 값을 더할때, 그리고 마지막 출력할때도 해줘야 한다.</br>
잊지말자! 이항계수 하면!! 파스칼삼각형!! </br>
점화식은 DP[i][j] = DP[i-1][j-1] + DP[i-1][j];!! </br>
