# 문제좀 똑바로읽자...
일단 첫번째, 난 비가 N만큼 오는건줄 알았다. ㅋㅋㅋ max값까지 구했어야되는건데 바보같이 풀었네..</br>
그리고 두번째, nx>=N을 해야되는데 nx > N을 해서 틀렸다. </br>
쉽게 풀 수 있는 문제라고 생각해서 문제 대충보고 대충코딩하는 습관좀 버려야되는데. </br>
그리고 이제부턴 main에 다 쓰지말고 객체지향적으로 해보자.. </br>
왤케 꼼꼼하지못할까.. </br>
