# 전체탐색..
괜히 처음에 어렵게 생각했다. </br>
조건 1. 같은 숫자가 나올 수 없다. </br>
조건 2. 0은 포함될 수 없다. </br>
이걸보고 먼저 파악하는게 중요한것 같다.</br>
어차피 세자리수는 123~ 999 까지이니. 여기서 같은숫자가 포함된것, 그리고 0이 포함된것을 뺴주고. </br>
민혁이가 대답하는것들에 비교를 해주며, 같은자리에서 같은숫자가 나오면 스트라이크를 올려 비교해주고, </br>
다른자리에서 같은 숫자가 나오면 볼을 올려 비교를 해주며 그것들까지 뺴주고 나면 남는것들을 출력해주면 된다. </br>
