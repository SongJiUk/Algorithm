# 이분탐색으로 푸는거 같긴했다.
근데 조건을 제대로 안읽어서 좀 오래걸린듯. </br>
코드를 더 이쁘게 짜고싶은데 지금 머리로는 잘 안짜진다. 집중이 왜 이렇게 안될까... </br>

이분탐색을 하는데 관건은 이거였다. </br>
1. 아예 안올리고 자르는 방법도있다. ( 시작지점이 0 일 경우도 있음.) </br>
2. 시작지점이 너무 커서 int형을 넘어갈 수도 있다. </br>
3. 목표로한것보다 못 가져갈 수도 있다. </br>
