# 생각을 좀만 더 해보면 쉽게 풀수있는 문제였는데 이해가 너무 오래걸린듯하다

모자 노란모자, 초록모자
눈장식 선글라스

이렇게 있다고 치면
모자는 2개가 있으니 총 3가지 경우가 있다.
1. 노란모자
2. 초록모자
3. 아무것도 안입는다.

눈장식은 1개가 있으니 총 2가지의 경우가 있다.
1. 선글라스
2. 아무것도 안입는다.

또 여기선 아무것도 입지 않는다. 라는 경우의수도있으니 1을 빼준다(문제의 조건에서 무조건 한가지 이상을 입으라고 써져있음)
3*2-1 = 5
5가지가 된다.
